	...
	while($row=$data->fetch_assoc()){
		...
		while($row2=$checkjoined->fetch_assoc()){
			...
			if($row['notifstatus']=='unread'){
				...
				echo'
					<div class="card" onclick="viewcontent(&quot;'.$row['userid'].'&quot;,&quot;'.$row['contentid'].'&quot;,&quot;'.$row['roomid'].'&quot;,&quot;'.$row['contenttitle'].'&quot;,&quot;'.$row['contentdetails'].'&quot;,&quot;'.$row['file'].'&quot;,&quot;'.$row['status'].'&quot;,&quot;'.$row['contentstatus'].'&quot;,&quot;'.$row['dateuploaded'].'&quot;)">
						<div class="card-body">
							<div>
								<h5 hidden >id: '.$row['contentid'].'</h5>
								<h5>'.$row['studentname'].' posted new content in '.$row['roomname'].'</h5>
