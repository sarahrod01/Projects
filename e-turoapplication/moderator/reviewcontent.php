											...
											<div class="d-flex">
												...
												<div>
													...
													<div class="d-flex">
														...
														<div><button type="submit" onclick="deletecomment(&quot;'.$row['commentid'].'&quot;,&quot;'.$row['comment'].'&quot;)" name="btndeletecomment" value="'.$row['commentid'].'"  style="margin-top: -20px; margin-left:20px;" class="form-control btn-danger" >delete comment</button></div>
													</div>
												</div>
