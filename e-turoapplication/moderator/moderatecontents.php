																		...
																		<div class="d-flex">
																			...
																			<div>
																				...
																				<div class="d-flex">
																					...
																					<div><button type="button" onclick="deletecomment(&quot;'.$row2['commentid'].'&quot;,&quot;'.$row2['comment'].'&quot;)" name="btndeletecomment" style="margin-top: -20px; margin-left:20px;" class="form-control btn-danger">delete comment</button></div>
																				</div>
																			</div>
